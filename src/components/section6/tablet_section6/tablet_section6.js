...
import "./tablet_section6.scss";
import politician_img from "../../../iamges/politician-img@2x.png";
import ios_arrow3 from "../../../iamges/ios-arrow3.svg";
import { Link } from "react-router-dom";

const TabletSection6 = () => {
  return (
    <div className="TabletSection6">
      <div className="container">
        <img className="politician" src={politician_img} alt="국회의원" />
        <hr />
